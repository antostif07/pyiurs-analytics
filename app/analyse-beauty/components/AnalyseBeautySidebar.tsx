...
const mainPath = '/analyse-beauty'

const menuItems = [
  { name: 'Vue Globale', href: mainPath, icon: LayoutDashboard },
  { name: 'Analyse Par Produit', href: `${mainPath}/by-product`, icon: ChartColumnBig },
...
export default function AnaluyseBeautySidenbar() {
    ...
    <aside className="w-64 bg-white border-r border-gray-100 h-screen flex flex-col fixed left-0 top-0 z-50">
      ...
      <div className="p-6 border-b border-gray-50">
        <h2 className="text-xl font-bold text-gray-900 tracking-tight">
          Analyse <span className="text-blue-600">Beauty</span>
        </h2>
        <p className="text-xs text-gray-400 mt-1">Tous les rapports des produits Beauty</p>
      </div>
