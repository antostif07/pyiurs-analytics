...
import { getAllAuditsAction } from "./audits-actions";
...
export default async function AuditsListPage() {
    ...
    const [audits, { data: shops }] = await Promise.all([
        getAllAuditsAction(),
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-border pb-6">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground font-light mt-1">
                        Contrôle des stocks unitaires par scanner et suivi de la démarque ($ USD).
                    </p>
                </div>
            ...
            <div className="space-y-3">
                ...
                {audits.length === 0 ? (
                    <div className="text-center py-16 bg-card border border-border border-dashed rounded-2xl">
                        ...
                        <h3 className="text-sm font-semibold text-foreground">Aucune session d'audit</h3>
                        <p className="text-xs text-muted-foreground mt-1 font-light max-w-sm mx-auto">
                            Cliquez sur "Lancer un Audit Physique" pour démarrer le comptage en boutique.
                        </p>
                    </div>
                ) : (
                        ...
                        <Table className="w-full text-left text-xs border-collapse">
                            <TableHeader className="bg-muted/40">
                                <TableRow className="border-b border-border hover:bg-transparent">
                                    ...
                                    <TableHead className="py-3 px-4 text-right w-24">Action</TableHead>
                                </TableRow>
                            </TableHeader>
                                    ...
                                    return (
                                        <TableRow key={a.id} className="hover:bg-muted/30 transition-colors group">
                                            ...
                                            <TableCell className="py-3 px-4 font-sans">
                                                <Badge variant="outline" className="text-[9px] font-medium border-border bg-muted/20">
                                                    {a.department}
                                                </Badge>
                                            </TableCell>
