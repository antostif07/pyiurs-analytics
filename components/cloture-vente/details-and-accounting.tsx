                    ...
                    <CardContent className="p-0 flex-1 flex flex-col min-h-0">
                        {initialData.sales.length > 0 ? (
                            <div className="flex-1 flex flex-col min-h-0">
                                <div className="grid grid-cols-2 gap-3 px-4 py-2 bg-slate-50 border-b text-xs font-medium shrink-0">
                                ...
                                <div className={`grid grid-cols-2 gap-3 px-4 py-3 border-t font-bold text-sm shrink-0 ${
                        ...
                        {initialData.expenses.length > 0 ? (
                            <div className="flex-1 flex flex-col min-h-0 space-y-4">
                                ...
                                <div className="border rounded-lg flex-1 flex flex-col min-h-0">
                                    <div className="grid grid-cols-2 gap-3 px-4 py-3 bg-blue-50 border-b shrink-0">
                                        <div className="flex items-center gap-2">
                                ...
                                {/* Caisse Épargne */}
                                <div className="border rounded-lg flex-1 flex flex-col min-h-0">
                                    <div className="grid grid-cols-2 gap-3 px-4 py-3 bg-green-50 border-b shrink-0">
                                        <div className="flex items-center gap-2">
                                ...
                                {/* Total général */}
                                <div className="grid grid-cols-2 gap-3 px-4 py-3 bg-slate-100 border-t font-bold text-sm rounded shrink-0">
                                    <div className="flex items-center gap-2">
